...
namespace IniFileParser.Model.Configuration
{
    ...
    public class IniParserConfiguration : ICloneable
    {
        ...
        /// <summary>
        ///     Default values used if an instance of <see cref="IniStringParser"/>
        ...
        ///     the <see cref="IniStringParser"/> will stop with an error.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     If set to <c>false</c> and the <see cref="IniStringParser"/> finds duplicate keys in a
        ...
        /// <summary>
        ///     If <c>true</c> the <see cref="IniStringParser"/> instance will thrown an exception
        ...
        /// <summary>
        ///     If set to <c>false</c> and the <see cref="IniStringParser"/> finds a duplicate section
        ...
        /// <summary>
        ///     If set to <c>false</c>, the <see cref="IniStringParser"/> stop with a error if you try
